...
//        }
        renderer.setSeriesVisible(0,isShapesVisible);// 数据点绘制形状
        setXAixs(plot);
        setYAixs(plot);
...
//            saveAsFile(chartPanel.getChart(),"D:\\1\\lol.png",900,500);
            CreateNewLineChartForPng("C:\\work\\java\\mutacenter\\lol2.png", NO_DATA_MSG, NO_DATA_MSG, NO_DATA_MSG, categorie, series, 900, 500);
